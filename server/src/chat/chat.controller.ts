...
router.get('/conversations/:id/messages', authMiddleware, async (req: any, res) => {
  const { id } = req.params;
...
router.post('/groups', authMiddleware, async (req: any, res) => {
...
router.get('/groups/:id', authMiddleware, async (req: any, res) => {
...
router.post('/groups/:id/members', authMiddleware, async (req: any, res) => {
...
router.delete('/groups/:id/members/:userId', authMiddleware, async (req: any, res) => {
  const groupId = parseInt(req.params.id);
...
router.get('/groups', authMiddleware, async (req: any, res) => {
  const userId = req.userId as number;
